...
let package = Package(
    ...
    targets: [
        .binaryTarget(
           name: "VLCKitXC",
           url: "https://github.com/rursache/VLCKitSPM/releases/download/nightly-build/VLCKit.xcframework.zip",
           checksum: "c0eb3b594eefac18413f995f5c08511b35c757f5ea08710c3f8093098ef6ce59"
        ),
        .target(
            name: "VLCKitSPM",
            dependencies: [
